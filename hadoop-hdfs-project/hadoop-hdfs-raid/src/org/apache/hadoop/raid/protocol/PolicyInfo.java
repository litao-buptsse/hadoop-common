...
import org.apache.hadoop.raid.FED_HAUtil;
...
public class PolicyInfo implements Writable {
  ...
  private String srcPath;          // the specified src pathstr
  ...
  public Path getSrcPath() {
    //return srcPath;
	return FED_HAUtil.getAvailablePath(srcPath, conf);
  }
  ...
  public Path[] getSrcPathExpanded() throws IOException {
	...
	FileStatus[] gpaths = FED_HAUtil.getGlobStatus(srcPath, conf);
    if (gpaths == null) {
      return null;
    }
  ...
  public void readFields(DataInput in) throws IOException {
    ...
    this.srcPath = Text.readString(in);

...
public class TestContainerLaunch extends BaseContainerManagerTest {
  ...
  public void testSpecialCharSymlinks() throws IOException  {
    ...
    try {
      ...
      ContainerLaunch.writeLaunchEnv(1, fos, env, resources, commands);
      fos.flush();
      fos.close();
  ...
  public void testInvalidSymlinkDiagnostics() throws IOException  {
    ...
    try {
      ...
      ContainerLaunch.writeLaunchEnv(2, fos, env, resources, commands);
      fos.flush();
      fos.close();
      FileUtil.setExecutable(tempFile, true);
  ...
  public void testInvalidEnvSyntaxDiagnostics() throws IOException  {
    ...
    try {
      ...
      List<String> commands = new ArrayList<String>();
      ContainerLaunch.writeLaunchEnv(3, fos, env, resources, commands);
      fos.flush();
      fos.close();
  ...
  public void testContainerLaunchStdoutAndStderrDiagnostics() throws IOException {
    ...
    try {
      ...
      ContainerLaunch.writeLaunchEnv(4, fos, env, resources, commands);
      fos.flush();
      fos.close();
